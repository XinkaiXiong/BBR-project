...
#define STOP_TIME        300.0       // Seconds
#define S_TO_R_BW        "10Gbps" // Server to router
#define S_TO_R_DELAY     "200ms"
#define R_TO_C_BW        "1Gbps"  // Router to client (bttlneck)
#define R_TO_C_DELAY     "200ms"
#define PACKET_SIZE      20000000      // Bytes.
...
int main (int argc, char *argv[]) {
  ...
  Simulator::Schedule(Seconds(0.01), Config::ConnectWithoutContext, "/NodeList/0/$ns3::TcpL4Protocol/SocketList/0/CongestionWindow", MakeBoundCallback (&CwndTracer1, CwndChanges_n0));
  Simulator::Schedule(Seconds(23.01), Config::ConnectWithoutContext, "/NodeList/1/$ns3::TcpL4Protocol/SocketList/0/CongestionWindow", MakeBoundCallback (&CwndTracer2, CwndChanges_n1));
  ...
  Simulator::Schedule(Seconds(0.01), Config::ConnectWithoutContext, "/NodeList/0/$ns3::TcpL4Protocol/SocketList/0/RTT", MakeBoundCallback (&RttTracer1, Rtt_n0));
  Simulator::Schedule(Seconds(23.01), Config::ConnectWithoutContext, "/NodeList/1/$ns3::TcpL4Protocol/SocketList/0/RTT", MakeBoundCallback (&RttTracer2, Rtt_n1));
